...
@section('content')
    <section id="secion-course" class="gway-section custom-container-md section section--spacing pb-0">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <section id="section-founder-detail" class="gway-section custom-container-md section section--spacing">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="card">
                        <div style="height: 640px" class="card__image"></div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="px-5">
                        ...
                        <div class="mt-40px">
                            <div class="mb-3">
                                <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.459 18.6667C11.459 15.6061 13.9401 13.125 17.0007 13.125H31.0007C34.0612 13.125 36.5423 15.6061 36.5423 18.6667V30.3333C36.5423 33.3939 34.0612 35.875 31.0007 35.875H17.0007C13.9401 35.875 11.459 33.3939 11.459 30.3333V18.6667ZM17.0007 14.875C14.9066 14.875 13.209 16.5726 13.209 18.6667V30.3333C13.209 32.4274 14.9066 34.125 17.0007 34.125H31.0007C33.0947 34.125 34.7923 32.4274 34.7923 30.3333V18.6667C34.7923 16.5726 33.0947 14.875 31.0007 14.875H17.0007Z" fill="#FCAF17"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.6508 18.1204C11.9526 17.7431 12.5033 17.6819 12.8806 17.9838L21.632 24.9849C23.0168 26.0927 24.9845 26.0927 26.3693 24.9849L35.1207 17.9838C35.4981 17.6819 36.0487 17.7431 36.3506 18.1204C36.6525 18.4978 36.5913 19.0484 36.214 19.3503L27.4625 26.3514C25.4386 27.9706 22.5628 27.9706 20.5388 26.3514L11.7874 19.3503C11.4101 19.0484 11.3489 18.4978 11.6508 18.1204Z" fill="#FCAF17"/>
                                    </svg>
